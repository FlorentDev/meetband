...
<div class="container-fluid">
  ...
  <input type="range" value="1" max="5" min="0" step="1"  style="width:85px">
    ...
    <div class="col-sm-9">
      ...
      <hr>
      <h2>Je recherche un chanteur</h2>
      ...
      <p>Bonjour , je recherche activement une personne avec un timbre de voix grave
      Merci de me contacter rapidement si vous êtes intéressés.</p>
